...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference("Campaign.count") do
      post campaigns_url, params: { campaign: { emails: @campaign.emails, name: @campaign.name, status: @campaign.status } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { emails: @campaign.emails, name: @campaign.name, status: @campaign.status } }
